                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between">
                      <p className="block font-sans text-base  antialiased text-white leading-relaxed ">
                        {item.name && (
                    ...
                    <p className="block font-sans text-white  text-xl  antialiased font-xl leading-relaxed ">
                      ${item.regularPrice}
                    </p>
                    <div>
                      <p className="font-sans text-xs antialiased  leading-relaxed text-blue-gray-900 flex items-center">
                        {item.address && (
